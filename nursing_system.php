...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login_form'])) {
    ...
    if ($row = $result->fetch_assoc()) {
        // simple compare (plain text password sa project)
        if ($password === $row['password']) {
            ...
            header('Location: nursing_system.php');
            exit;
        } else {
                ...
                <form id="admission-form" method="POST" action="save_record.php">
                    ...
                    <div class="section">
                        ...
                        <div id="trauma-details" style="margin-top:10px; display:none; border-radius:8px;border:1px solid var(--border);padding:10px 12px;background:#F8FCFF;">
                            ...
                            <div class="field">
                                ...
                                <input name="trauma_other" type="text">
                            </div>
                            <div class="field">
                                <label>Mechanism of Injury</label>
                                <input name="trauma_mech" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-220">
                            ...
                            <div class="field">
                                ...
                                <input name="medical_history" type="text" required>
                            </div>
                            <div class="field" style="grid-column:1/-1;">
                                <label>Current Medications / Home Meds</label>
                                <input name="home_meds" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-220">
                            ...
                            <div class="field">
                                <label>PhilHealth / Insurance Details</label>
                                <input name="philhealth" type="text">
                            </div>
                            <div class="field">
                                <label>Primary / Assigned Nurse</label>
                                <input name="primary_nurse" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-220">
                            <div class="field">
                                ...
                                <input id="vs_patient_name" name="patient_name" type="text" required>
                            </div>
                            <div class="field">
                                <label for="vs_patient_id">Patient ID / Hospital No.</label>
                                <input id="vs_patient_id" name="patient_id" type="text" required>
                            </div>
                            <div class="field">
                                <label for="vs_age">Age</label>
                                <input id="vs_age" name="age" type="number" min="0" required>
                            </div>
                            <div class="field">
                                <label for="vs_sex">Sex</label>
                                <select id="vs_sex" name="sex" required>
                                    <option value="">--Select--</option>
                                    <option value="F">Female</option>
                                    <option value="M">Male</option>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-190">
                            <div class="field">
                                ...
                                <input id="temp" name="temp" type="number" step="0.1" required>
                            </div>
                            <div class="field">
                                <label for="pulse">Pulse Rate (bpm)</label>
                                <input id="pulse" name="pulse" type="number" min="0" required>
                            </div>
                            <div class="field">
                                <label for="resp">Respiratory Rate (bpm)</label>
                                <input id="resp" name="resp" type="number" min="0" required>
                            </div>
                            <div class="field">
                                <label for="bp">Blood Pressure (mmHg)</label>
                                <input id="bp" name="bp" type="text" required>
                            </div>
                            <div class="field">
                                <label for="spo2">SpO₂ (%)</label>
                                <input id="spo2" name="spo2" type="number" min="0" max="100" required>
                            </div>
                            <div class="field">
                                <label for="pain">Pain Score (0–10)</label>
                                <input id="pain" name="pain" type="number" min="0" max="10">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-190">
                            <div class="field">
                                ...
                                <input id="gcs_e" name="gcs_e" type="number" min="1" max="4">
                            </div>
                            <div class="field">
                                <label for="gcs_v">Verbal (V)</label>
                                <input id="gcs_v" name="gcs_v" type="number" min="1" max="5">
                            </div>
                            <div class="field">
                                <label for="gcs_m">Motor (M)</label>
                                <input id="gcs_m" name="gcs_m" type="number" min="1" max="6">
                            </div>
                            <div class="field">
                                <label for="gcs_total">GCS Total</label>
                                <input id="gcs_total" name="gcs_total" type="number" min="3" max="15" readonly>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-190">
                            ...
                            <div class="field">
                                ...
                                <input id="bmi" name="bmi" type="text" readonly>
                                <small>Calculated from weight and height</small>
                            </div>
                            <div class="field">
                                <label for="bmi_category">BMI Category</label>
                                <input id="bmi_category" name="bmi_category" type="text" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-2">
                            <div class="field">
                                ...
                                <input id="nurse" name="nurse" type="text" required>
                            </div>
                            <div class="field">
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-220">
                            <div class="field">
                                ...
                                <input id="med_patient_name" name="patient_name" type="text" required>
                            </div>
                            <div class="field">
                                <label for="med_patient_id">Patient ID / Hospital No.</label>
                                <input id="med_patient_id" name="patient_id" type="text" required>
                            </div>
                            <div class="field">
                                <label for="med_age">Age</label>
                                <input id="med_age" name="age" type="number" min="0" required>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input id="med_allergies" name="med_allergies" type="text" required>
                            </div>
                            <div class="field">
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-190">
                            ...
                            <div class="field">
                                ...
                                <input id="med_strength" name="med_strength" type="text" required>
                            </div>
                            <div class="field">
                                <label for="med_dose">Dosage</label>
                                <input id="med_dose" name="med_dose" type="text" required>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input id="med_frequency" name="med_frequency" type="text">
                            </div>
                            <div class="field">
                                <label for="med_indication">Indication / Purpose</label>
                                <input id="med_indication" name="med_indication" type="text" required>
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input id="med_given_by" name="med_given_by" type="text" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="section">
                        ...
                        <div class="grid-auto-220">
                            <div class="field">
                                ...
                                <textarea id="med_adverse" name="med_adverse"></textarea>
                            </div>
                            <div class="field">
                                <label for="med_response">Response / Post-assessment</label>
                                <textarea id="med_response" name="med_response"></textarea>
                            </div>
                            <div class="field">
                                <label for="med_notes">Nurse Notes</label>
                                <textarea id="med_notes" name="med_notes"></textarea>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    // handle #hash for redirect from save_record.php
    window.addEventListener('DOMContentLoaded', () => {
        const hash = window.location.hash;
        if (hash === '#vitals-section' || hash === '#meds-section' || hash === '#admission-section') {
            showSection(hash.substring(1));
        } else {
            showSection('admission-section');
        }
    });
    ...
    function updateGCS() {
        if (!gcsE || !gcsV || !gcsM || !gcsTotal) return;
